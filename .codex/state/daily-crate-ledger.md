...
- CI run `35460465743` for the superseded `faa036d` head was canceled. Commit `a1f1f39` and this proof-state update still need to be pushed to draft PR #264; protected exact-head CI and two new independent Luna/high reviews remain pending. The PR remains draft, with no build, full manual regression, merge, release, or deployment performed.
