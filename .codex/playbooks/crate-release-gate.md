...
- DMG envelope gate: Electron Builder signs the completed DMG with the configured Developer ID Application identity before submission; DMG signing, notarization, stapling, and primary-signature assessment before and after stapling are validated.
