...
| `.codex/ops/crate-preferences.md` | Explicit, source-linked Bryant/Jenna preference policy with expiry and conflict handling. | A reusable workflow or presentation preference is proposed or applied. |
| `.codex/playbooks/crate-workflow-evaluation.md` | Synthetic evaluation contract for routes, tiers, approvals, privacy, and stop gates. | A Crate operating workflow should be evaluated before promotion. |
